...
<div class="container">
  ...
  <form action="RegClient" method="POST" role="form" name="forma">      
    ...
    <div class="form-group" ng-class="">
    <label>Ingrese un teléfono</label>      
  ...
  <center>Al hacer clic en "Crear cuenta", aceptas los Términos y las Condiciones de Carrywash y la Política de privacidad.</center>
